...
public class MyRouteBuilder extends RouteBuilder {
    ...
    public void configure() {
    	...
    	from("hdfs2://localhost:9000/input/message1.xml").
    			setHeader("CamelFileName", simple( "message2.xml", String.class)).
    			to("stream:out")
	    		.to("hdfs2://localhost:9000/output/");

//    	from("hdfs2://localhost:9000/test/message3.txt")
//    	 .to("jms:test.MyQueue");
